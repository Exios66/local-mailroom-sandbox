...
| --- | --- | --- | --- | --- |
| SAND-026 | Simplify sandbox extraction prompts + document field-level instructions | cursor | **in_progress** | GitHub #32. Parallel `*_simplified` stems; run-20/run-30 pin them. Catalog promotion tracked in eval-environment #4–#8. Do not close #21. |
