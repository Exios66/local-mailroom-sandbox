...
| `MODAL_VLLM_SCALEDOWN_SECONDS` | `600` | idle warm window (efficient conservative; raise for longer soak) |
...
| Idle burn window | `MODAL_VLLM_SCALEDOWN_SECONDS` | `600` (raise for longer soak) | deploy env |
